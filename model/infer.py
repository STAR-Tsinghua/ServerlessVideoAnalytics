...
from detect_simple import model
...
def infer(input_path, output_path, model_name, weight_path, width, height, qp, crop, device="cpu"):
    """Do object detection."""
    yolo = model(weight_path, device)
    ...
    with open(dets_path, 'w', 1) as f, open(profile_path, 'w', 1) as f_profile:
        ...
        for i, img_path in enumerate(img_paths):
            ...
            detections = yolo.infer(img_path)
...
def load_object_detection_results(filename):
    ...
    Return
        ...
        frame_id, xmin, ymin, xmax, ymax, t(class), score, obj_id
